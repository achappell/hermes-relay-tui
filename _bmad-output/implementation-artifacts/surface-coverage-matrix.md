...
| E | `E-1`–`E-5` | `hermes-relay-tui` / firmware | Native display/reducer evidence exists for parts of E-2/E-5; [STD-7](spec-standard-7-esp32-touch-audio-session-adapter.md) requires a Home-owned Touch admission/ready-binding predecessor, and physical C6 audio waits on its board/pin/S3-link contract; voice capture, response-audio adapter, and active typed-choice slice `2-E-5` remain. |
