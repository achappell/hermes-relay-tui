...
| W/K | `WK-1` | `hermes-relay-tui` / web | Browser voice/display foundation, safe post-playback retry/error handling, recognizer-release handoff, and verified PCM delivery exist; automated DOM checks now pass (178 tests, zero Svelte diagnostics, production build), while physical Safari/Guided Access, iPad permission, secure-channel, audio, and touch validation remain. Direct-use typed-choice rendering `2-WK-6` depends on server authority `2-WK-5`. |
