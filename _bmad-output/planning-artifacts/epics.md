...
### Surface-specific Epic 1 story map — decision 2026-09-10; Android parity addendum 2026-09-11; Android delivery addendum 2026-09-12
...
| `A-4` | Android | Configure the media-server relay over Tailscale and store its credential in the Android Keystore, with multi-profile add/delete/switch and honest off-tailnet unavailable state. |
| `A-5` | Android | Interrupt an active turn and stop response playback without a false phase claim. |
| `A-6` | Android | Hands-free continuation capture and echo-safe barge-in, matching shipped iOS behavior. |
| `A-7` | Android | Typed turns and normalized event delivery. |
| `A-8` | Android | Response audio playback. |
| `A-9` | Android | Microphone capture and on-device transcription. |
