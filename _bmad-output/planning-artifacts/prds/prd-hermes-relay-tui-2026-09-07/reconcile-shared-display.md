...
The PRD preserves the shared state/action contract, room-local Active Turn mirroring, live Transcription, explicit prompt mirroring without touch response, ESP32-S3 and iPad Display targets, Ambient Surface fallback, recovery states, closest-Device arbitration, and the single-room pilot boundary.
