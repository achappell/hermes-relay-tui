...
EXPORTED_FUNCTIONS='["_display_wasm_abi_version","_display_wasm_init","_display_wasm_reset","_display_wasm_state_from_name","_display_wasm_apply_snapshot","_display_wasm_begin_typed_choice_snapshot","_display_wasm_set_typed_choice_option","_display_wasm_finish_typed_choice_snapshot","_display_wasm_validate_choice","_display_wasm_validate_typed_choice","_display_wasm_validate_dismiss","_display_wasm_set_connection_state","_display_wasm_set_pointer","_display_wasm_action_pending","_display_wasm_action_id","_display_wasm_action_choice","_display_wasm_action_operation","_display_wasm_action_object_id","_display_wasm_action_freshness","_display_wasm_action_clear","_display_wasm_view_state","_display_wasm_view_sequence","_display_wasm_view_is_busy","_display_wasm_view_connection_healthy","_display_wasm_view_can_choose","_display_wasm_view_can_explore","_display_wasm_view_can_dismiss","_display_wasm_framebuffer","_display_wasm_framebuffer_width","_display_wasm_framebuffer_height","_display_wasm_tick"]'
