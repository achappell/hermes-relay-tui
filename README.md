...
The default connection is `ws://REDACTED-PRIVATE-ENDPOINT:8792/voice-session`, with session ID `hybrid-tui`. Override those values when needed:
...
| `HERMES_VOICE_SESSION_URL` | `ws://REDACTED-PRIVATE-ENDPOINT:8792/voice-session` |
